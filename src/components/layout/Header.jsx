...
import { faHotel, faUser, faCog, faBolt, faShield } from '@fortawesome/free-solid-svg-icons'
          ...
          >
            ...
            >
              ...
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-400 to-cyan-400 flex items-center justify-center relative overflow-hidden">
                ...
                <FontAwesomeIcon icon={faHotel} className="text-white text-lg z-10" />
              </div>
            </motion.div>
            <div>
              ...
              <p className="text-xs text-red-400/80" style={{ textShadow: '0 0 3px rgba(220, 38, 38, 0.5)' }}>
